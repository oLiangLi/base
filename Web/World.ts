...
export interface CipherSuiteV0 extends RandomNumberGenerator {
  ...
  ChaCha20(state: Buffer /* 64 */, callback: (stream: Buffer /* 64 */, index: integer) => boolean): void;

  XChaChaPoly(pubkey: CipherX25519 | Buffer, cipher?: CipherX25519): [aead: CipherAEAD, pubkey: Buffer];
